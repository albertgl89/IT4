            ...
            @foreach (Team::all() as $team)
                <div class="md:flex md:flex-wrap rounded-tr-xl rounded-bl-xl shadow-lg hover:to-violet-900/80 bg-gradient-to-tl from-indigo-800  to-violet-900 text-white md:max-w-1/4 min-w-fit">
                    <div
                        ...
                        <div class="m-2 p-2 mx-auto my-auto grid grid-flow-col md:flex md:flex-wrap justify-items-center content-center items-center gap-1 col-span-2 md:col-span-4 w-max md:w-full">
                            
                            <a href="teams/{{ $team->id }}" class="gold-pill-btn w-fit md:w-full text-center">Detalls</a>
                            <a href="{{ url('teams/' . $team->id . '/edit') }}" class="sm:inline hidden w-1/3 mx-auto m-1"><span
                                    class="material-icons text-xl gold-pill-btn md:w-full text-center">
                                    edit
                                </span></a>
                            <a href="{{ url('teams/' . $team->id . '/delete') }}" class="sm:inline hidden w-1/3 mx-auto m-1"><span
